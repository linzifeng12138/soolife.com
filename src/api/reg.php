...
/**
 * @Author: Marte
 * @Date:   2018-02-08 16:35:59
 * @Last Modified by:   Marte
 * @Last Modified time: 2018-02-08 19:48:01
 */
    include 'connect.php';
    //4、接收来自前端register.js的用户名、密码信息
    $username = isset($_REQUEST['username']) ? $_REQUEST['username'] : '';
    $password = isset($_REQUEST['password']) ? $_['password'] : '123456';
    ...
    $sql = "insert into soolifeuserdata (username,password) values('$username','$password')";
